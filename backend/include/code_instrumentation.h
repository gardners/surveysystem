...
#define LOG_MESSAGE(...)                                                       \
  code_instrumentation_log(__FILE__, __LINE__, __FUNCTION__, LOG_LEVEL_OFF,    \
                           ##__VA_ARGS__)

#if COMPILE_LOG_LEVEL >= LOG_LEVEL_ERROR

#define LOG_ERROR(...)                                                         \
  code_instrumentation_log(__FILE__, __LINE__, __FUNCTION__, LOG_LEVEL_ERROR,  \
                           ##__VA_ARGS__)
...
#define LOG_WARN(...)                                                          \
  code_instrumentation_log(__FILE__, __LINE__, __FUNCTION__, LOG_LEVEL_WARN,   \
                           ##__VA_ARGS__)
...
#define LOG_NOTE(...)                                                          \
  code_instrumentation_log(__FILE__, __LINE__, __FUNCTION__, LOG_LEVEL_NOTE,   \
                           ##__VA_ARGS__)
...
#define LOG_TRACE(...)                                                         \
  code_instrumentation_log(__FILE__, __LINE__, __FUNCTION__, LOG_LEVEL_TRACE,  \
                           ##__VA_ARGS__)
...
#define LOG_ENTRY LOG_ENTRY_PREFIX

#define LOG_EXIT LOG_EXIT_SUFFIX

#define LOG_ENTRY_RECURSIVE_FUNCTION LOG_ENTRY_PREFIX_RECURSIVE_FUNCTION

#define LOG_EXIT_RECURSIVE_FUNCTION LOG_EXIT_SUFFIX_RECURSIVE_FUNCTION
