/*Type definitions for Survey JavaScript library v1.0.38
...
export declare class SurveyQuestionRadiogroup extends SurveyQuestionElementBase {
    ...
    protected getItems(cssClasses: any): Array<any>;
    protected readonly textStyle: any;
    protected renderRadio(key: string, item: ItemValue, isChecked: boolean, otherItem: JSX.Element, isFirst: boolean, cssClasses: any): JSX.Element;
    protected renderOther(cssClasses: any): JSX.Element;
}
...
export declare class SurveyQuestionMatrixDropdownBase extends SurveyQuestionElementBase {
    ...
    renderRow(index: number, row: MatrixDropdownRowModelBase, cssClasses: any): JSX.Element;
    renderColumnAsRow(index: number, column: MatrixDropdownColumn, cssClasses: any): JSX.Element;
    protected addHeaderLeft(elements: Array<JSX.Element>): void;
    protected addHeaderRight(elements: Array<JSX.Element>): void;
    protected addBottomColumnAsRows(elements: Array<JSX.Element>): void;
}
export declare class SurveyQuestionMatrixDropdownRowBase extends ReactSurveyElement {
    ...
    protected setProperties(nextProps: any): void;
    render(): JSX.Element;
    protected AddLeftCells(tds: Array<JSX.Element>): void;
    protected AddRightCells(tds: Array<JSX.Element>): void;
}
...
export declare class SurveyQuestionMatrixDropdown extends SurveyQuestionMatrixDropdownBase {
    constructor(props: any);
    protected readonly matrix: QuestionMatrixDropdownModel;
    protected addHeaderLeft(elements: Array<JSX.Element>): void;
    renderRow(index: number, row: MatrixDropdownRowModelBase, cssClasses: any): JSX.Element;
    renderRowsAsHeaders(): JSX.Element;
}
export declare class SurveyQuestionMatrixDropdownRow extends SurveyQuestionMatrixDropdownRowBase {
    constructor(props: any);
    protected AddLeftCells(tds: Array<JSX.Element>): void;
}
...
export declare class SurveyQuestionMatrixDynamic extends SurveyQuestionMatrixDropdownBase {
    ...
    render(): JSX.Element;
    renderRow(index: number, row: MatrixDropdownRowModelBase, cssClasses: any): JSX.Element;
    protected addHeaderRigth(elements: Array<JSX.Element>): void;
...
export declare class SurveyQuestionMatrixDynamicRow extends SurveyQuestionMatrixDropdownRowBase {
    constructor(props: any);
    protected setProperties(nextProps: any): void;
    protected AddRightCells(tds: Array<JSX.Element>): void;
}
...
export declare class SurveyValidator extends Base {
        ...
        validateAllValues(value: any, values: any, properties: any, name?: string): ValidatorResult;
        getLocale(): string;
...
export declare class ItemValue {
    ...
    static runConditionsForItems(items: Array<ItemValue>, filteredItems: Array<ItemValue>, runner: ConditionRunner, values: any, properties: any): boolean;
    ...
    getConditionRunner(): ConditionRunner;
}
...
export interface ISurvey extends ITextProcessor {
        ...
        clearFiles(name: string, value: any, clearCallback: (status: string, data: any) => any): any;
...
export declare class SurveyError {
        text: string;
        constructor(text?: string, locOwner?: ILocalizableOwner);
        readonly locText: LocalizableString;
        getText(): string;
...
export declare class ExceedSizeError extends SurveyError {
    constructor(maxSize: number, locOwner?: ILocalizableOwner);
...
export declare class Operand {
    ...
    fillVariables(vars: Array<string>): void;
    toString(): string;
}
...
export declare class PanelModelBase extends SurveyElement implements IPanel, IConditionRunner, ILocalizableOwner {
        ...
        protected childVisibilityChangeHandler: () => void;
...
export declare class Question extends QuestionBase implements IValidatorOwner {
        ...
        valueName: string;
        protected propertyValueChanged(name: string, oldValue: any, newValue: any): void;
        protected onNameValueChanged(oldValue: string, newValue: string): void;
        /**
...
export declare class SurveyModel extends Base implements ISurvey, ISurveyData, ISurveyImpl, ISurveyTriggerOwner, ILocalizableOwner {
        ...
        protected deleteDataValueCore(valuesHash: any, key: string): void;
        /**
        ...
        /**
            ...
            */
        downloadFile(questionName: string, content: string, callback: (status: string, data: any) => any): void;
        /**
            ...
            */
        clearFiles(name: string, value: any, callback: (status: string, data: any) => any): void;
        updateChoicesFromServer(question: IQuestion, choices: Array<ItemValue>, serverResult: any): Array<ItemValue>;
